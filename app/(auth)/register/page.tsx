    ...
    >
      <div className="glass rounded-4xl shadow-brand-lg border border-white/80 p-8 sm:p-10">
        ...
        <motion.div variants={fadeUpVariants} className="text-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-azure border border-brand-navy/15 text-xs font-bold text-brand-navy mb-4">
            <span className="w-1.5 h-1.5 rounded-full bg-brand-success" />
            Gratuit pour toujours
          </div>
          <h1 className="text-3xl font-black text-brand-dark mb-2">Créer mon compte</h1>
        ...
        <motion.form variants={fadeUpVariants} onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-bold text-brand-dark mb-1.5">Prénom</label>
            <input
              type="text"
              required
              value={formData.name}
          ...
          <div>
            <label className="block text-sm font-bold text-brand-dark mb-1.5">Mot de passe</label>
            <input
              type="password"
              required
              minLength={8}
